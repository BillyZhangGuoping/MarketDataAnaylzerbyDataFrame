...
class GeneticOptimizeStrategy(object):
    ...
    def optimize(self):
        ...
        toolbox.register("mutate", self.mutArrayGroup, parameterlist = self.parameter_generate, indpb=0.6)  # 注册变异：随机生成一定区间内的整数
    ...
    def retrunPop(self,pop):
        '''
        返回一个DataFrame, 可以导出execl
        '''
        pass
